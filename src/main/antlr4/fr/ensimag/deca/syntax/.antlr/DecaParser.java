// Generated from /Users/macbookpro/ensimag/GL/Projet_GL/src/main/antlr4/fr/ensimag/deca/syntax/DecaParser.g4 by ANTLR 4.9.2
...
public class DecaParser extends AbstractDecaParser {
	...
	public final List_decl_varContext list_decl_var(ListDeclVar l,AbstractIdentifier t) throws RecognitionException {
		...
		try {
			...
			while (_la==COMMA) {
				...
				assert(((List_decl_varContext)_localctx).dv2.tree != null);_localctx.l.add(((List_decl_varContext)_localctx).dv2.tree);
	...
	public final List_instContext list_inst() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << PRINTLN) | (1L << TRUE) | (1L << NEW) | (1L << PRINTLNX) | (1L << WHILE) | (1L << NULL) | (1L << PRINTX) | (1L << READINT) | (1L << FALSE) | (1L << READFLOAT) | (1L << RETURN) | (1L << IF) | (1L << PRINT) | (1L << THIS) | (1L << IDENT) | (1L << MINUS) | (1L << OPARENT) | (1L << EXCLAM) | (1L << SEMI) | (1L << INT) | (1L << FLOAT) | (1L << STRING))) != 0)) {
				{
				{
				setState(122);
		...
		try {
			...
			case PRINTX:
				...
				match(SEMI);
				            ...
				            assert(((InstContext)_localctx).list_expr.tree != null);
				            ((InstContext)_localctx).tree =  new Printx(true, ((InstContext)_localctx).list_expr.tree);
			...
			case PRINTLNX:
				...
				match(SEMI);
				            ...
				            assert(((InstContext)_localctx).list_expr.tree != null);
				            ((InstContext)_localctx).tree =  new Printlnx(true, ((InstContext)_localctx).list_expr.tree);
	...
	public final If_then_elseContext if_then_else() throws RecognitionException {
		...
		enterRule(_localctx, 18, RULE_if_then_else);
		    ...
		    ListInst else_init = new ListInst();
		    ListInst else_if_init = new ListInst();
		...
		try {
			...
			match(CBRACE);
			        ...
			        ((If_then_elseContext)_localctx).tree =  new IfThenElse( ((If_then_elseContext)_localctx).condition.tree, ((If_then_elseContext)_localctx).li_if.tree, else_if_init);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					match(CBRACE);
					        ...
					        IfThenElse temp = new IfThenElse(((If_then_elseContext)_localctx).elsif_cond.tree, ((If_then_elseContext)_localctx).elsif_li.tree, else_init);
					        setLocation(temp, ((If_then_elseContext)_localctx).elsif);
					        else_if_init.add(temp);
					        else_if_init = else_init;
					        else_init = new ListInst();
	...
	public final List_exprContext list_expr() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << TRUE) | (1L << NEW) | (1L << NULL) | (1L << READINT) | (1L << FALSE) | (1L << READFLOAT) | (1L << THIS) | (1L << IDENT) | (1L << MINUS) | (1L << OPARENT) | (1L << EXCLAM) | (1L << INT) | (1L << FLOAT) | (1L << STRING))) != 0)) {
				{
				setState(214);
					...
					case 2:
						{
						                      ...
						                      // we matched "e.i"
						                      ((Select_exprContext)_localctx).tree =  new AttributeCall(((Select_exprContext)_localctx).e1.tree, ((Select_exprContext)_localctx).i.tree);
						                      setLocation(_localctx.tree, (((Select_exprContext)_localctx).e1!=null?(((Select_exprContext)_localctx).e1.start):null));
		...
		try {
			...
			case THIS:
				...
				((LiteralContext)_localctx).THIS = match(THIS);
				        ...
				        ((LiteralContext)_localctx).tree =  new This(Boolean.parseBoolean((((LiteralContext)_localctx).THIS!=null?((LiteralContext)_localctx).THIS.getText():null)));
	...
	public final IdentContext ident() throws RecognitionException {
		...
		try {
			...
			((IdentContext)_localctx).IDENT = match(IDENT);
			        ...
			        ((IdentContext)_localctx).tree =  new Identifier(SYMTAB.create((((IdentContext)_localctx).IDENT!=null?((IdentContext)_localctx).IDENT.getText():null)));
	...
	public static final String _serializedATN =
		...
		"\3\2\2\2\u00f5\u00f6\f\3\2\2\u00f6\u00f7\7\62\2\2\u00f7\u00f8\5\36\20"+
		...
		"\7\60\2\2\u0126\u0127\5$\23\2\u0127\u0128\b\22\1\2\u0128\u013e\3\2\2\2"+
		"\u0129\u012a\f\6\2\2\u012a\u012b\7/\2\2\u012b\u012c\5$\23\2\u012c\u012d"+
		"\b\22\1\2\u012d\u013e\3\2\2\2\u012e\u012f\f\5\2\2\u012f\u0130\7\34\2\2"+
		"\u0130\u0131\5$\23\2\u0131\u0132\b\22\1\2\u0132\u013e\3\2\2\2\u0133\u0134"+
		"\f\4\2\2\u0134\u0135\7\35\2\2\u0135\u0136\5$\23\2\u0136\u0137\b\22\1\2"+
		"\u0137\u013e\3\2\2\2\u0138\u0139\f\3\2\2\u0139\u013a\7\b\2\2\u013a\u013b"+
		"\5.\30\2\u013b\u013c\b\22\1\2\u013c\u013e\3\2\2\2\u013d\u0124\3\2\2\2"+
		"\u013d\u0129\3\2\2\2\u013d\u012e\3\2\2\2\u013d\u0133\3\2\2\2\u013d\u0138"+
		...
		"\23\2\2\u019e\u019f\7&\2\2\u019f\u01a0\7\'\2\2\u01a0\u01b7\b\27\1\2\u01a1"+
		"\u01a2\7\26\2\2\u01a2\u01a3\7&\2\2\u01a3\u01a4\7\'\2\2\u01a4\u01b7\b\27"+
		"\1\2\u01a5\u01a6\7\f\2\2\u01a6\u01a7\5\62\32\2\u01a7\u01a8\7&\2\2\u01a8"+
		...
		"\2\u01c1\u01c2\7\n\2\2\u01c2\u01ca\b\31\1\2\u01c3\u01c4\7\25\2\2\u01c4"+
		"\u01ca\b\31\1\2\u01c5\u01c6\7\32\2\2\u01c6\u01ca\b\31\1\2\u01c7\u01c8"+
		"\7\20\2\2\u01c8\u01ca\b\31\1\2\u01c9\u01bb\3\2\2\2\u01c9\u01bd\3\2\2\2"+
		"\u01c9\u01bf\3\2\2\2\u01c9\u01c1\3\2\2\2\u01c9\u01c3\3\2\2\2\u01c9\u01c5"+
		"\3\2\2\2\u01c9\u01c7\3\2\2\2\u01ca\61\3\2\2\2\u01cb\u01cc\7\33\2\2\u01cc"+
		...
		"\1\2\u01dd\67\3\2\2\2\u01de\u01df\7\17\2\2\u01df\u01e0\5\62\32\2\u01e0"+
		...
		"\b \1\2\u01f4\u01f5\7\24\2\2\u01f5\u01f7\b \1\2\u01f6\u01f3\3\2\2\2\u01f6"+
		...
		"\u021a\3\2\2\2\u0212\u0213\7\7\2\2\u0213\u0214\7&\2\2\u0214\u0215\5H%"+
